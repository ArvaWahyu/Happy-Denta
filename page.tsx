    ...
    <div className="min-h-screen bg-white relative">
      ...
      <div className="fixed bottom-8 right-8 z-50 flex items-center gap-4">
        <a 
          ...
          className="flex items-center gap-3 bg-[#00B6D6] text-white pl-6 pr-8 py-4 rounded-full shadow-xl hover:bg-[#0095b0] 
              ...
              {[
                {
                  ...
                  answer: "Klinik buka setiap hari Senin–Sabtu, pukul 09.00–20.00 WIB. Hari Minggu dan libur nasional tutup (atau bisa disesuaikan)."
                },
                {
                ...
                },
                {
                  ...
                  answer: "Anda bisa reservasi melalui WhatsApp di +62 895 0611 3003, DM Instagram kami @happydenta, atau langsung datang ke klinik."
                },
                {
                ...
                },
                {
                  ...
                  answer: "Kami beralamat di [alamat lengkap klinik]. Lokasi mudah dijangkau dan tersedia parkir kendaraan."
                }
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <p className="flex items-center text-gray-400 hover:text-[#00B6D6] transition-colors">
                  <MapPin className="w-5 h-5 mr-3 text-[#00B6D6]" />
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2024 HappyDenta. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
